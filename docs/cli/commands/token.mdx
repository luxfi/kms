---
title: "kms token"
description: "Manage your KMS identity access tokens"
---

```bash 
kms token renew <ua-access-token>
```

## Description
The KMS `token` command allows you to manage your universal auth access tokens. 
