...
This command enables you to perform list, lease, renew lease, and revoke lease operations on dynamic secrets within your KMS project.

### Sub-commands

<Accordion title="kms dynamic-secrets">
...
```bash
# Example
kms dynamic-secrets --projectId=<project-id>
```
...
```bash
# Example
kms dynamic-secrets --project-slug=<project-slug>
```
...
```bash
# Example
kms dynamic-secrets --token=<token>
```
...
```bash
# Example
kms dynamic-secrets --path="/" --env=dev
```

</Accordion>
</Accordion>
<Accordion title="kms dynamic-secrets lease create">
  This command is used to create a new lease for a dynamic secret.

```bash
$ kms dynamic-secrets lease create <dynamic-secret-name>
```
...
```bash
# Example
kms dynamic-secrets lease create dynamic-secret-postgres --plain
```
...
```bash
# Example
kms dynamic-secrets lease create <dynamic-secret-name> --path="/" --env=dev
```
...
```bash
# Example
kms dynamic-secrets lease create <dynamic-secret-name> --projectId=<project-id>
```
...
```bash
# Example
kms dynamic-secrets lease create <dynamic-secret-name> --project-slug=<project-slug>
```
...
```bash
# Example
kms dynamic-secrets lease create <dynamic-secret-name> --token=<token>
```
...
```bash
# Example
kms dynamic-secrets lease create <dynamic-secret-name> --ttl=<ttl>
```
...
<Accordion title="Kubernetes">
  <Accordion title="--kubernetes-namespace">
    ...
    ```bash
    # Example
    kms dynamic-secrets lease create <dynamic-secret-name> --kubernetes-namespace=<namespace>
    ```
...
<Accordion title="kms dynamic-secrets lease list">
  This command is used to list leases for a dynamic secret.

```bash
$ kms dynamic-secrets lease list <dynamic-secret-name>
```
...
```bash
# Example
kms dynamic-secrets lease list <dynamic-secret-name> --path="/" --env=dev
```
...
```bash
# Example
kms dynamic-secrets lease list <dynamic-secret-name> --projectId=<project-id>
```
...
```bash
# Example
kms dynamic-secrets lease list <dynamic-secret-name> --project-slug=<project-slug>
```
...
```bash
# Example
kms dynamic-secrets lease list <dynamic-secret-name> --token=<token>
```

</Accordion>
</Accordion>

<Accordion title="kms dynamic-secrets lease renew">
  This command is used to renew a lease before it expires.

```bash
$ kms dynamic-secrets lease renew <lease-id>
```
...
```bash
# Example
kms dynamic-secrets lease renew <lease-id> --path="/" --env=dev
```
...
```bash
# Example
kms dynamic-secrets lease renew <lease-id> --projectId=<project-id>
```
...
```bash
# Example
kms dynamic-secrets lease renew <lease-id> --project-slug=<project-slug>
```
...
```bash
# Example
kms dynamic-secrets lease renew <lease-id> --token=<token>
```
...
```bash
# Example
kms dynamic-secrets lease renew <lease-id> --ttl=<ttl>
```

</Accordion>
</Accordion>

<Accordion title="kms dynamic-secrets lease delete">
  This command is used to delete a lease.

```bash
$ kms dynamic-secrets lease delete <lease-id>
```
...
```bash
# Example
kms dynamic-secrets lease delete <lease-id> --path="/" --env=dev
```
...
```bash
# Example
kms dynamic-secrets lease delete <lease-id> --projectId=<project-id>
```
...
```bash
# Example
kms dynamic-secrets lease delete <lease-id> --project-slug=<project-slug>
```
...
```bash
# Example
kms dynamic-secrets lease delete <lease-id> --token=<token>
```
