---
title: "KMS Organizational Structure Blueprint"
sidebarTitle: "Organization Structure"
description: "Learn how to structure your projects, secrets, and other resources within KMS."
---

KMS is designed to provide comprehensive, centralized, and efficient management of secrets, certificates, and encryption keys within organizations. Below is an overview of KMS's structured components, which developers and administrators can leverage for optimal project management and security posture.

### 0. Cluster/Instance

- **Best Practice**: In most cases, a single KMS instance or cluster is sufficient. Multiple clusters are typically only necessary for large, globally distributed organizations.
- **Use Cases**:
...
- **Definition**: An KMS [organization](/documentation/platform/organization) is a set of projects that use the same billing.
- **Use Cases**: 
...
- **Definition and Role**: [Projects](/documentation/platform/project) are the highest-level construct within an [organization](/documentation/platform/organization) in KMS. They serve as the primary container for all functionalities.
...
- **Purpose and Benefits**: To promote reusability and avoid redundancy, KMS supports the use of imports. This allows secrets, folders, or entire environments to be referenced across multiple projects as needed.
...
KMS’s access control framework is unified for both human users and machine identities, ensuring consistent management across the board.
...
For larger-scale organizations, automating configurations through **Terraform** or other infrastructure-as-code (IaC) tools is advisable. Manual configurations may lead to errors, so leveraging IaC enhances reliability and consistency in managing KMS's robust capabilities.

This structured approach ensures that KMS's functionalities are fully leveraged, providing both flexibility and rigorous control over an organization's sensitive information and access needs.