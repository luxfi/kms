...
KMS leverages a Key Management Service (KMS) to securely encrypt and decrypt secrets in your projects.

## Overview

KMS's KMS ensures the security of your project's secrets through the following mechanisms:
...
KMS supports the use of external KMS solutions to enhance security and compliance. You can configure your project to use services like [AWS Key Management Service](./aws-kms) or [GCP Key Management Service](./gcp-kms) for managing encryption.
