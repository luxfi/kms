...
Before you begin, you'll first need to set up a GCP Service Account, add a KMS key and set the required permissions.
  ...
  <Steps>
    <Step title="Create a GCP Service Account">
      ...
      **Cloud KMS Viewer** and **Cloud KMS CryptoKey Encrypter/Decrypter*** roles, then click **Continue**.
      ...
      <Info>
        ...
        Once you have successfully set up GCP KMS with KMS, you should permanently delete the JSON file.
      </Info>
    </Step>
    ...
    <Step title="Add a GCP KMS Key">
      ...
      8. You should see the key in the list of keys. We're now ready to set it up in KMS.
    </Step>
...
You now have a GCP KMS Key configured at the organization level. You can assign these GCP KMS keys to existing KMS projects by visiting the 'Project Settings' page.
