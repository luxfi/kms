---
title: "User Groups"
description: "Manage user groups in KMS."
---
...
A (user) group is a collection of users that you can create in an KMS organization to more efficiently manage permissions and access control for multiple users together. For example, you can have a group called `Developers` with the `Developer` role containing all the developers in your organization.
...
In the following steps, we explore how to create and use user groups to provision user access to projects in KMS.
