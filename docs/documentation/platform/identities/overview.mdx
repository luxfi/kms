...
description: "Learn more about identities to interact with resources in KMS."
---

To interact with secrets and resource with KMS, it is important to understand the concept of identities. 
...
<CardGroup cols={2}>
  <Card href="./user-identities" title="People (User Identities)" icon="people" color="#000000">
    Learn more about the concept on user identities in KMS. 
  </Card>
  <Card
    ...
    color="#000000"
  >
    Understand the concept of machine identities in KMS. 
  </Card>
</CardGroup>
