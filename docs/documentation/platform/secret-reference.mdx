...
description: "Learn the fundamentals of secret referencing and importing in KMS."
---

## Secret Referencing

KMS's secret referencing functionality makes it possible to reference the value of a "base" secret when defining the value of another secret.
...
KMS's Secret Imports functionality makes it possible to import the secrets from another environment or folder into the current folder context.
