...
description: "Learn how to configure JumpCloud LDAP for authenticating into KMS."
---
...
<Steps>
    <Step title="Prepare LDAP in JumpCloud">
        ...
        will be used as a privileged service account to facilitate KMS's ability to bind/search the LDAP directory.
