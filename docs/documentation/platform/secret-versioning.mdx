...
description: "Learn how secret versioning works in KMS."
---
...
The secret versioning functionality is heavily connected to [Point-in-time Recovery](/documentation/platform/pit-recovery) of secrets in KMS.
