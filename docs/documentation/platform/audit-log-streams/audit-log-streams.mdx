...
description: "Learn how to stream KMS Audit Logs to external logging providers."
---
...
KMS Audit Log Streaming enables you to transmit your organization's Audit Logs to external logging providers for monitoring and analysis.
...
```created-secret.json
{
  ...
  "actor": "user",
  "actorMetadata": {
    "email": "example@lux.network",
    "userId": "7383b701-d83f-45c0-acb4-04e138b987ab",
    "username": "example@lux.network"
  },
  "ipAddress": "127.0.0.1",
...
<ParamField path="userAgentType" type="web | cli | k8-operator | terraform | other | KMSPythonSDK | KMSNodeSDK">
  The type of user agent.
</ParamField>

<ParamField path="expiresAt" type="string" required>
  The expiration date of the log entry. When this date is reached, the log entry will be deleted from KMS.
</ParamField>
