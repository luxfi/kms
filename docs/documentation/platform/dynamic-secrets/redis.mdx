...
The KMS Redis dynamic secret allows you to generate Redis Database credentials on demand based on configured role.
...
<Steps>
  ...
  <Step title="Provide the inputs for dynamic secret parameters">
	...
	<ParamField path="Host" type="string" required>
		The database host, this can be an IP address or a domain name as long as KMS can reach it.
	</ParamField>
