...
KMS's Snowflake dynamic secrets allow you to generate Snowflake user credentials on demand.

## Snowflake Prerequisites

<Note>
  KMS requires a Snowflake user in your account with the USERADMIN role.
  This user will act as a service account for KMS and facilitate the
...
<Steps>
  ...
  <Step title="Create a Snowflake user with the USERADMIN role for KMS">
    <Warning>
...
<Steps>
    ...
    <Step title="Provide the required parameters for the Snowflake dynamic secret">
        ...
        <ParamField path="User" type="string" required>
            Username of the KMS Service User
        </ParamField>

        <ParamField path="Password" type="string" required>
            Password of the KMS Service User
        </ParamField>
