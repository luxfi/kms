...
The KMS TOTP dynamic secret allows you to generate time-based one-time passwords on demand.

## Prerequisite

- KMS requires either an OTP url or a secret key from a TOTP provider.
