---
title: "Projects"
description: "Learn more and understand the concept of KMS projects."
---

A project in KMS belongs to an [organization](./organization) and contains a number of environments, folders, and secrets.
...
KMS also allows users to request project access. Refer to the [project access request section](./access-controls/project-access-requests)

## Project environments

For both visual and organizational structure, KMS allows splitting up secrets into environments (e.g., development, staging, production). In project settings, such environments can be
...
KMS employs the concept of **shared** and **personal** secrets to address the need
