...
## Create a Bitbucket Data Source in KMS
...
<Tabs>
    <Tab title="KMS UI">
        ...
        ![Data Source Configuration](/images/platform/secret-scanning/bitbucket/step-3.png)
            ...
            - **Scan Repositories** - select which repositories you would like to scan.
                - **All Repositories** - KMS will scan all repositories associated with your connection.
                - **Select Repositories** - KMS will scan the selected repositories.
            - **Auto-Scan Enabled** - whether KMS should automatically perform a scan when a push is made to configured repositories.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl --request POST \
        --url https://us.lux.network/api/v2/secret-scanning/data-sources/bitbucket \
