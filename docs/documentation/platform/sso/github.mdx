---
title: "GitHub SSO"
description: "Learn how to configure GitHub SSO for KMS."
---

Using GitHub SSO on a self-hosted instance of KMS requires configuring an OAuth2 application in GitHub and registering your instance with it.
...
<Steps>
  ...
  <Step title="Add your OAuth application credentials to KMS">
    ...
    Back in your KMS instance, make sure to set the following environment variables:
    ...
    - `SITE_URL`: The URL of your self-hosted instance of KMS - should be an absolute URL including the protocol (e.g. https://kms.lux.network)
      
    Once added, restart your KMS instance and log in with GitHub.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Why is GitHub SSO not working?">
    It is likely that you have misconfigured your self-hosted instance of KMS. You should:
    ...
    For example, if the former is `https://kms.lux.network/api/v1/sso/github` then the latter should be `https://kms.lux.network`.
  </Accordion>
</AccordionGroup>