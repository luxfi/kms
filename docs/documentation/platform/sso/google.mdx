---
title: "Google SSO"
description: "Learn how to configure Google SSO for KMS."
---

Using Google SSO on a self-hosted instance of KMS requires configuring an OAuth2 application in GCP and registering your instance with it.
...
<Steps>
  ...
  <Step title="Add your OAuth2 application credentials to KMS">
    ...
    Once added, restart your KMS instance and log in with Google
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Why is Google SSO not working?">
    ...
    For example, if the former is `https://kms.lux.network/api/v1/sso/google` then the latter should be `https://kms.lux.network`.
  </Accordion>
</AccordionGroup>