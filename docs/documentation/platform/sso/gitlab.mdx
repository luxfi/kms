---
title: "GitLab SSO"
description: "Learn how to configure GitLab SSO for KMS."
---

Using GitLab SSO on a self-hosted instance of KMS requires configuring an OAuth application in GitLab and registering your instance with it.
...
<Steps>
  ...
  <Step title="Add your OAuth application credentials to KMS">
    ...
    Once added, restart your KMS instance and log in with GitLab.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Why is GitLab SSO not working?">
    ...
    For example, if the former is `https://kms.lux.network/api/v1/sso/gitlab` then the latter should be `https://kms.lux.network`.
  </Accordion>
</AccordionGroup>