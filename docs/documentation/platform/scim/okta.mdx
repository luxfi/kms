---
title: "Okta SCIM"
description: "Learn how to configure SCIM provisioning with Okta for KMS."
---
...
Prerequisites:
- [Configure Okta SAML for KMS](/documentation/platform/sso/okta)
...
<Steps>
    ...
    <Step title="Configure SCIM in Okta">
        ...
        Now Okta can provision/deprovision users and user groups to/from your organization in KMS.
    </Step>
</Steps>
