---
title: "Azure SCIM"
description: "Learn how to configure SCIM provisioning with Azure for KMS."
---
...
Prerequisites:
- [Configure Azure SAML for KMS](/documentation/platform/sso/azure)

<Steps>
    <Step title="Create a SCIM token in KMS">
        In KMS, head to the **Single Sign-On (SSO)** page and select the **Provisioning** tab. Under SCIM Configuration,
    ...
    <Step title="Configure SCIM in Azure">
        ...
        Alternatively, you can go to **Overview** and press **Start provisioning** to have Azure start provisioning/deprovisioning users to KMS.
        
        ![SCIM Azure](/images/platform/scim/azure/scim-azure-start-provisioning.png)
        
        Now Azure can provision/deprovision users to/from your organization in KMS.
    </Step>
</Steps>
...
<Accordion title="Why do SCIM-provisioned users have to finish setting up their account?">
    KMS's SCIM implmentation accounts for retaining the end-to-end encrypted architecture of KMS because we decouple the **authentication** and **decryption** steps in the platform. 
