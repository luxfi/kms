...
description: "Learn about KMS's access control toolset."
---

To make sure that users and machine identities are only accessing the resources and performing actions they are authorized to, KMS supports a wide range of access control tools. 
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    color="#000000"
  >
    Track every action performed by user and machine identities in KMS. 
  </Card>
</CardGroup>
