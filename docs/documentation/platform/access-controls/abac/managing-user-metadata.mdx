...
<Tabs>
  ...
  <Tab title="Automatically Populate Metadata">
    For organizations using SAML for **user logins**, KMS automatically maps metadata attributes from SAML assertions to user identities on every login. This enables dynamic policies based on the user's SAML attributes.
  </Tab>
</Tabs>
