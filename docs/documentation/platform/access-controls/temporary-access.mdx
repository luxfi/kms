...
Certain environments and secrets are so sensitive that it is recommended to not give any user permanent access to those. For such use cases, KMS supports the functionality of **Temporary Access** provisioning. 
