...
sidebarTitle: "MFA"
description: "Learn how to secure your KMS account with MFA."
---
...
<Steps>
  <Step title="Open your KMS Application in the Microsoft Entra Admin Center">
    ![Entra KMS
    app](/images/platform/mfa/entra/mfa_entra_kms_app.png)
  </Step>
  ...
  <Step title="MFA is now Required When Accessing KMS">
