...
title: "KMS Java SDK"
sidebarTitle: "Java"
url: "https://github.com/KMS/java-sdk?tab=readme-ov-file#kms-java-sdk"
icon: "/images/sdks/languages/java.svg"
---

{
/*
If you're working with Java, the official [KMS Java SDK](https://github.com/KMS/sdk/tree/main/languages/java) package is the easiest way to fetch and work with secrets for your application.

- [Maven Package](https://github.com/KMS/sdk/packages/2019741)
- [Github Repository](https://github.com/KMS/sdk/tree/main/languages/java)
...
import com.kms.sdk.KMSClient;
import com.kms.sdk.schema.*;
...
public class Example {
    public static void main(String[] args) {
        ...
        KMSClient client = new KMSClient(settings);
...
This example demonstrates how to use the KMS Java SDK in a Java application. The application retrieves a secret named `TEST` from the `dev` environment of the `PROJECT_ID` project.
...
public class App {
    public static void main(String[] args) {
        ...
        // Create a new KMS Client
        KMSClient client = new KMSClient(settings); // Your client!
    }
}
```
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        ...
        <ParamField query="setSiteURL()" type="string" default="https://kms.lux.network" optional>
...
options.setKey(key);
options.setPlaintext("KMS is awesome!");
