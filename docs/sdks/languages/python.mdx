---
title: "KMS Python SDK"
sidebarTitle: "Python"
url: "https://github.com/KMS/python-sdk-official?tab=readme-ov-file#kms-python-sdk"
icon: "/images/sdks/languages/python.svg"
---

{/* If you're working with Python, the official [kms-python](https://github.com/KMS/sdk/edit/main/crates/kms-py) package is the easiest way to fetch and work with secrets for your application.

-   [PyPi Package](https://pypi.org/project/kms-python/)
-   [Github Repository](https://github.com/KMS/sdk/edit/main/crates/kms-py)

## Basic Usage

```py
from flask import Flask
from kms_client import ClientSettings, KMSClient, GetSecretOptions, AuthenticationOptions, UniversalAuthMethod
...
This example demonstrates how to use the KMS Python SDK with a Flask application. The application retrieves a secret named "NAME" and responds to requests with a greeting that includes the secret value.
...
Run `pip` to add `kms-python` to your project

```console
$ pip install kms-python
```
...
```py
from kms_client import ClientSettings, KMSClient, AuthenticationOptions, UniversalAuthMethod
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        ...
        <ParamField query="site_url" type="string" default="https://kms.lux.network" optional>
          Your self-hosted absolute site URL including the protocol (e.g. `https://kms.lux.network`)
        </ParamField>

        <ParamField query="ssl_certificate_path" optional>
          Optionally provide a path to a custom SSL certificate file. This can be substituted by setting the `KMS_SSL_CERTIFICATE` environment variable to the contents of the certificate.
        </ParamField>
...
**Using the SDK directly**
```py
from kms_client import ClientSettings, KMSClient, AuthenticationOptions, GCPIDTokenAuthMethod
...
**Using the SDK directly**
```py
from kms_client import ClientSettings, KMSClient, AuthenticationOptions, GCPIamAuthMethod
...
**Using the SDK directly**
```py
from kms_client import ClientSettings, KMSClient, AuthenticationOptions, AWSIamAuthMethod
...
**Using the SDK directly**
```python
from kms_client import KMSClient, ClientSettings, AuthenticationOptions, AzureAuthMethod

kubernetes_client = KMSClient(ClientSettings(
    auth=AuthenticationOptions(
...
**Using the SDK directly**
```python
from kms_client import KMSClient, ClientSettings, AuthenticationOptions, KubernetesAuthMethod
