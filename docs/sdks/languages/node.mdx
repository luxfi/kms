---
title: "KMS Node.js SDK"
sidebarTitle: "Node.js"
url: "https://github.com/KMS/node-sdk-v2?tab=readme-ov-file#kms-nodejs-sdk"
icon: "/images/sdks/languages/node.svg"
---

{/*
If you're working with Node.js, the official [KMS Node SDK](https://github.com/KMS/sdk/tree/main/languages/node) package is the easiest way to fetch and work with secrets for your application.

- [NPM Package](https://www.npmjs.com/package/@kms/sdk)
- [Github Repository](https://github.com/KMS/sdk/tree/main/languages/node)
...
const client = new KMSClient({
    siteUrl: "https://kms.lux.network", // Optional, defaults to https://kms.lux.network
    auth: {
      universalAuth: {
...
This example demonstrates how to use the KMS Node SDK with an Express application. The application retrieves a secret named "NAME" and responds to requests with a greeting that includes the secret value.
...
Run `npm` to add `@kms/sdk` to your project.
...
<Tabs>
  <Tab title="ES6">
    ```js
    import { KMSClient, LogLevel } from "@kms/sdk";
  ...
  <Tab title="ES5">
    ```js
    const { KMSClient } = require("@kms/sdk");
