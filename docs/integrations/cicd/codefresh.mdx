---
title: "Codefresh"
description: "How to sync secrets from KMS to Codefresh"
---
...
<Steps>
  <Step title="Authorize KMS for Codefresh">
    ...
    Press on the Codefresh tile and input your Codefresh API key to grant KMS access to your Codefresh account.

    ![integrations codefresh authorization](../../images/integrations/codefresh/integrations-codefresh-auth.png)

  </Step>
  <Step title="Start integration">
    Select which KMS environment secrets you want to sync to which Codefresh service and press create integration to start syncing secrets to Codefresh.
