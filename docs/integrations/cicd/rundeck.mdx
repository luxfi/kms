---
title: "Rundeck"
description: "How to sync secrets from KMS to Rundeck"
---
...
<Steps>
  <Step title="Authorize KMS for Rundeck">
    ...
    Press on the Rundeck tile and input your Rundeck instance Base URL and User API token to grant KMS access to manage Rundeck keys

    ![integrations rundeck authorization](../../images/integrations/rundeck/integrations-rundeck-auth.png)

  </Step>
  <Step title="Start integration">
    Select which KMS environment secrets you want to sync to a Rundeck Key Storage Path and press create integration to start syncing secrets to Rundeck.
