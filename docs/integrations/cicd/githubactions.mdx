...
description: "How to sync secrets from KMS to GitHub Actions"
---

<Note>
  Alternatively, you can use KMS's official GitHub Action
  [here](https://github.com/KMS/secrets-action).
</Note>

KMS lets you sync secrets to GitHub at the organization-level, repository-level, and repository environment-level.
...
<Tabs>
  <Tab title="Usage">
    <Steps>
      <Step title="Authorize GitHub KMS App">
        Navigate to your project's integrations tab in KMS and press on the GitHub tile.
        ...
        Install and authorize the GitHub application. This will redirect you back to the KMS integration page.

      </Step>
      <Step title="Configure KMS GitHub integration">
        Select which KMS environment secrets you want to sync to which GitHub organization, repository, or repository environment.
  ...
  <Tab title="Self-Hosted Setup">
    Using the GitHub integration with app authentication on a self-hosted instance of KMS requires configuring an application on GitHub
    ...
    <Steps>
      ...
      <Step title="Add your application credentials to KMS">
        ...
        Back in your KMS instance, add the five new environment variables for the credentials of your GitHub application:
        ...
        Once added, restart your KMS instance and use the GitHub integration via app authentication.
      </Step>
    </Steps>
...
<Tabs>
  <Tab title="Usage">
    <Steps>
      <Step title="Authorize KMS for GitHub">
        Navigate to your project's integrations tab in KMS and press on the GitHub tile.
        ...
        Grant KMS access to your GitHub account (organization and repo privileges).
  ...
  <Tab title="Self-Hosted Setup">
    Using the GitHub integration on a self-hosted instance of KMS requires configuring an OAuth application in GitHub
    and registering your instance with it.
    <Steps>
      ...
      <Step title="Add your OAuth application credentials to KMS">
        ...
        Back in your KMS instance, add two new environment variables for the credentials of your GitHub OAuth application:
        ...
        Once added, restart your KMS instance and use the GitHub integration.
      </Step>
    </Steps>
