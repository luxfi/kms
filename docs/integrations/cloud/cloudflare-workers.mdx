...
description: "How to sync secrets from KMS to Cloudflare Workers"
---
...
<Steps>
  <Step title="Authorize KMS for Cloudflare Workers">
    ...
    Press on the Cloudflare Workers tile and input your Cloudflare API token and account ID to grant KMS access to your Cloudflare Workers.

    ![integrations cloudflare authorization](../../images/integrations/cloudflare/integration-cloudflare-workers-connect.png)

  </Step>
  <Step title="Start integration">
    Select which KMS environment secrets you want to sync to Cloudflare Workers and press create integration to start syncing secrets.
