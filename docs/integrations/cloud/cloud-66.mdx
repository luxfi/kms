---
title: "Cloud 66"
description: "How to sync secrets from KMS to Cloud 66"
---
...
Name it **kms** and check **Public** and **Admin**. Then click "Create Token"
...
### Go to KMS Integration Page

Click on the Cloud 66 tile and enter your API token to grant KMS access to your Cloud 66 account.
![integrations cloud 66 tile in kms dashboard](../../images/integrations/cloud-66/integrations-cloud-66-kms-dashboard.png)

Enter your Cloud 66 Personal Access Token here. Then click "Connect to Cloud 66".
![integrations cloud 66 tile in kms dashboard](../../images/integrations/cloud-66/integrations-cloud-66-paste-pat.png)


## Start integration

Select which KMS environment secrets you want to sync to which Cloud 66 stacks and press create integration to start syncing secrets to Cloud 66.
![integrations laravel forge](../../images/integrations/cloud-66/integrations-cloud-66-create.png)

<Warning>
  Any existing environment variables in Cloud 66 will be deleted when you start syncing. Make sure to add all the secrets into the KMS dashboard first before doing any integrations.
</Warning>
