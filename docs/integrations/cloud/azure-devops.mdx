---
title: "Azure DevOps"
description: "How to sync secrets from KMS to Azure DevOps"
---
...
You'll need to create a new personal access token (PAT) in order to authenticate KMS with Azure DevOps.
<Steps>
...
<Steps>
  ...
  <Step title="Configure the integration">
    Select KMS project and secret path you want to sync into Azure DevOps.
...
Now you have successfully integrated KMS with Azure DevOps. Your existing and future secret changes will automatically sync to Azure DevOps.
