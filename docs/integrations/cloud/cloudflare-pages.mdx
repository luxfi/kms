...
description: "How to sync secrets from KMS to Cloudflare Pages"
---
...
<Steps>
  <Step title="Authorize KMS for Cloudflare Pages">
    ...
    Press on the Cloudflare Pages tile and input your Cloudflare API token and account ID to grant KMS access to your Cloudflare Pages.

    ![integrations cloudflare authorization](../../images/integrations/cloudflare/integrations-cloudflare-auth.png)

  </Step>
  <Step title="Start integration">
    Select which KMS environment secrets you want to sync to Cloudflare and press create integration to start syncing secrets.
