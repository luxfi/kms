---
title: "Railway"
description: "How to sync secrets from KMS to Railway"
---
...
<Steps>
  <Step title="Authorize KMS for Railway">
    ...
    Press on the Railway tile and input your Railway API Key to grant KMS access to your Railway account.

    ![integrations railway authorization](../../images/integrations/railway/integrations-railway-authorization.png)

  </Step>
  <Step title="Start integration">
    Select which KMS environment secrets you want to sync to which Railway project and environment (and optionally service). Lastly, press create integration to start syncing secrets to Railway.

    ![integrations create railway](../../images/integrations/railway/integrations-railway-create.png)

    <Note>
      KMS integrates with both Railway's [shared variables](https://blog.railway.app/p/shared-variables-release) at the project environment level as well as service variables at the service level.
