---
title: "Overview"
description: "How to use KMS to inject secrets and configs into various 3-rd party services and frameworks."
---

Integrations allow environment variables to be synced from KMS into your local development workflow, CI/CD pipelines, and production infrastructure.

Missing an integration? [Throw in a request](https://github.com/luxfi/kms/issues).
