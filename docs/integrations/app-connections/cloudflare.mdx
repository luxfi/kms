...
description: "Learn how to configure a Cloudflare Connection for KMS."
---

KMS supports connecting to Cloudflare using API tokens and Account ID for secure access to your Cloudflare services.

## Configure API Token and Account ID for KMS
...
<Steps>
  ...
  <Step title="Configure Token Permissions">
    ...
    <Tabs>
      <Tab title="Secret Sync">
        <AccordionGroup>
          <Accordion title="Cloudflare Pages">
            Use the following permissions to grant KMS access to sync secrets to Cloudflare Pages:
          ...
          <Accordion title="Cloudflare Workers">
            Use the following permissions to grant KMS access to sync secrets to Cloudflare Workers:
      ...
      <Tab title="PKI">
          Use the following permissions to grant KMS access to verify certificates using DNS TXT records with ACME:
...
## Setup Cloudflare Connection in KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **Cloudflare Connection** is now available for use in your KMS
