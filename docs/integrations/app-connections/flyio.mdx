...
description: "Learn how to configure a Fly.io Connection for KMS."
---

KMS supports the use of [Access Tokens](https://fly.io/docs/security/tokens/) to connect with Fly.io.
...
## Create Fly.io Connection in KMS
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **Fly.io Connection** is established and ready to use with your KMS projects.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/flyio \
