...
description: "Learn how to configure a Checkly Connection for KMS."
---

KMS supports the use of [API Keys](https://app.checklyhq.com/settings/user/api-keys) to connect with Checkly.
<Note>
...
## Create a Checkly Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Checkly Connection** will be successfully created and ready to use with your KMS projects.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/checkly \
