...
description: "Learn how to configure a Railway Connection for KMS."
---

KMS supports the use of [API Tokens](https://docs.railway.com/guides/public-api#creating-a-token) to connect with Railway.
...
## Create a Railway Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Railway Connection** will be successfully created and ready to use with your KMS projects.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/railway \
