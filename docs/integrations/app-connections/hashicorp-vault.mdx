...
description: "Learn how to configure a Hashicorp Vault Connection for KMS."
---

<Note>
    KMS is compatible with Vault Self-hosted, HCP Vault Dedicated, and HCP Vault Enterprise deployments. Please note that HCP Generic Secrets are currently not supported.
</Note>

KMS supports two methods for connecting to Hashicorp Vault.
...
## Setup Vault Connection in KMS

<Tabs>
    <Tab title="KMS UI">
        <Steps>
            <Step title="Navigate to App Connections">
                In your KMS dashboard, go to **Organization Settings** and select the **App Connections** tab.
            ...
            <Step title="Add Connection">
                ...
                ![Select Vault Connection](/images/app-connections/hashicorp-vault/vault-kms-connect-page.png)
            </Step>
            <Step title="Configure Connection">
                ...
                ![Vault Configure Connection](/images/app-connections/hashicorp-vault/vault-kms-connect-modal.png)
            ...
            <Step title="Connection Created">
                ...
                ![Vault Connection Created](/images/app-connections/hashicorp-vault/vault-kms-connect-success.png)
            </Step>
        </Steps>
    </Tab>
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/hashicorp-vault \
