...
description: "Learn how to configure a Bitbucket Connection for KMS."
---

KMS supports the use of [API Tokens](https://support.atlassian.com/bitbucket-cloud/docs/api-tokens/) to connect with Bitbucket.

<Tip>
    KMS recommends creating a dedicated Bitbucket account with access restricted to only the resources your use case requires.
</Tip>
...
## Create Bitbucket Connection in KMS
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **Bitbucket Connection** is established and ready to use with your KMS projects.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/bitbucket \
