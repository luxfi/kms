...
description: "Learn how to configure an Auth0 Connection for KMS."
---

KMS supports the use of [Client Credentials](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow) to connect with your Auth0 applications.
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://kms.lux.network/api/v1/app-connections/auth0 \
