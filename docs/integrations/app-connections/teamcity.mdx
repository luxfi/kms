...
description: "Learn how to configure a TeamCity Connection for KMS."
---

KMS supports connecting to TeamCity using Access Tokens.

## Setup TeamCity Connection in KMS
...
<Steps>
    ...
    <Step title="Create the Access Token">
        Click the **Create access token** button and provide a name for your token (e.g., "KMS Integration"). You may set an expiration date or leave it blank for no expiry.
    ...
    <Step title="Setup TeamCity Connection in KMS">
        <Tabs>
            <Tab title="KMS UI">
                ...
                4. Connection Created
                    ...
                    After clicking Create, your **TeamCity Connection** is established and ready to use with your KMS projects.
            ...
            <Tab title="API">
                ...
                ```bash Request
                curl    --request POST \
                        --url https://kms.lux.network/api/v1/app-connections/teamcity \
