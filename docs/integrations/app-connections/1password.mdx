...
description: "Learn how to configure a 1Password Connection for KMS."
---

KMS supports the use of [Service Accounts](https://developer.1password.com/docs/service-accounts) to connect with 1Password.
...
## Create 1Password Connection in KMS
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **1Password Connection** is established and ready to use with your KMS projects.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/1password \
