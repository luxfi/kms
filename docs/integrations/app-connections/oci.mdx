...
description: "Learn how to configure an Oracle Cloud Infrastructure Connection for KMS."
---
...
KMS supports the use of [API Signing Key Authentication](https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm) to connect with OCI.
    ...
    <Step title="Create policy">
        ...
        <Tabs>
            <Tab title="Secret Sync">
                ...
                If you'd like to grant KMS access to all compartments, replace instances of `compartment <compartment name>` with `tenancy`.
            </Tab>
        </Tabs>
...
## Create OCI Connection in KMS

<Tabs>
    <Tab title="KMS UI">
        <Steps>
            <Step title="Navigate to App Connections">
                In your KMS dashboard, go to **Organization Settings** and select the [**App Connections**](https://kms.lux.network/organization/app-connections) tab.
            ...
            <Step title="Fill out the OCI Connection Modal">
                ...
                - The User OCID from [earlier steps](https://lux.network/docs/integrations/app-connections/oci#create-oci-user)
                - The Tenancy OCID from [earlier steps](https://lux.network/docs/integrations/app-connections/oci#create-oci-user)
                - The Region from [earlier steps](https://lux.network/docs/integrations/app-connections/oci#create-oci-user)
                - The Fingerprint from [earlier steps](https://lux.network/docs/integrations/app-connections/oci#create-oci-user)
                - The Private Key PEM from [earlier steps](https://lux.network/docs/integrations/app-connections/oci#create-oci-user)

                ![OCI Connection Modal](/images/app-connections/oci/app-connection-modal.png)
            </Step>
            <Step title="Connection Created">
                After clicking Create, your **OCI Connection** is established and ready to use with your KMS projects.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/oci \
