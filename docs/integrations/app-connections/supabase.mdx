...
description: "Learn how to configure a Supabase Connection for KMS."
---

KMS supports the use of [Personal Access Tokens](https://supabase.com/dashboard/account/tokens) to connect with Supabase.
...
## Create a Supabase Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Supabase Connection** will be successfully created and ready to use with your KMS projects.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/supabase \
