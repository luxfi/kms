...
description: "Learn how to configure an Okta Connection for KMS."
---

KMS supports the use of [API Tokens](https://developer.okta.com/docs/guides/create-an-api-token/main/) to connect with Okta.
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **Okta Connection** is established and ready to use with your KMS projects.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/okta \
