...
description: "Learn how to configure a Databricks Connection for KMS."
---

KMS supports the use of [service principals](https://docs.databricks.com/en/admin/users-groups/service-principals.html) to connect with your Databricks workspaces.

## Configure a Service Principal for KMS
...
<Steps>
    ...
    <Step title="Add Service Principal">
        Select the **Add New** option and create a service principal for KMS.
...
## Setup Databricks Connection in KMS
