...
description: "Learn how to configure a Vercel Connection for KMS."
---

KMS supports connecting to Vercel using API Tokens.

## Setup Vercel Connection in KMS
...
<Steps>
    ...
    <Step title="Create the API Token">
        Click the **Create** button and provide a name for your token (e.g., "KMS Integration"). 
    ...
    <Step title="Setup Vercel Connection in KMS">
        <Tabs>
            <Tab title="KMS UI">
                ...
                4. Connection Created
                    ...
                    After clicking Create, your **Vercel Connection** is established and ready to use with your KMS projects.
            ...
            <Tab title="API">
                ...
                ```bash Request
                curl    --request POST \
                        --url https://kms.lux.network/api/v1/app-connections/vercel \
