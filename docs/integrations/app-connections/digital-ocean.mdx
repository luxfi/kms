...
description: "Learn how to configure a DigitalOcean Connection for KMS."
---

KMS supports the use of [API Tokens](https://cloud.digitalocean.com/account/api/tokens) to connect with DigitalOcean.
...
## Create a DigitalOcean Connection in KMS

<Tabs>
  <Tab title="KMS UI">
    <Steps>
      <Step title="Navigate to App Connections">
        In your KMS dashboard, go to **Organization Settings** and open the [**App Connections**](https://kms.lux.network/organization/app-connections) tab.
      ...
      <Step title="Connection created">
        After submitting the form, your **DigitalOcean Connection** will be successfully created and ready to use with your KMS projects.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/digital-ocean \
