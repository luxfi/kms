...
description: "Learn how to configure a Netlify Connection for KMS."
---

KMS supports the use of [Personal Access Tokens](https://docs.netlify.com/api/get-started/#get-access-tokens) to connect with Netlify.  
<Note>
...
## Create a Netlify Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Netlify Connection** will be successfully created and ready to use with your KMS projects.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/netlify \
