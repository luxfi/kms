...
description: "Learn how to configure a GitHub Connection for KMS."
---

KMS supports two methods for connecting to GitHub.

<Tabs>
    <Tab title="GitHub App (Recommended)">
        KMS will use a GitHub App with finely grained permissions to connect to GitHub.
        ...
        <Accordion title="Self-Hosted Instance">
            ...
            <Steps>
                ...
                <Step title="Add your application credentials to KMS">
                    ...
                    Back in your KMS instance, you can configure the GitHub App credentials in one of two ways:
                    ...
                    **Option 2: Environment Variables**
                    ...
                    Once configured, you can use the GitHub integration via app authentication. If you configured the credentials using environment variables, restart your KMS instance for the changes to take effect. If you configured them through the server admin panel, allow approximately 5 minutes for the changes to propagate.
                </Step>
            </Steps>
        </Accordion>

        ## Setup GitHub Connection in KMS
        ...
        <Steps>
            ...
            <Step title="Install GitHub App">
                ...
                Install and authorize the GitHub application. This will redirect you back to KMS's App Connections page.
    ...
    <Tab title="OAuth">
        KMS will use an OAuth App to connect to GitHub.
        ...
        <Steps>
            ...
            <Step title="Grant Access">
                You will then be redirected to the GitHub to grant KMS access to your GitHub account (organization and repo privileges).
                Once granted, you will redirect you back to KMS's App Connections page.
