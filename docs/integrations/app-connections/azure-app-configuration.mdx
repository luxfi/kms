...
description: "Learn how to configure a Azure App Configuration Connection for KMS."
---

KMS currently only supports two methods for connecting to Azure, which are OAuth and Client Secrets.

<Accordion title="Self-Hosted Instance">
  Using the Azure App Configuration connection on a self-hosted instance of KMS requires configuring an application in Azure
  ...
  **Prerequisites:**
  ...
  <Steps>
    ...
    <Step title="Add your application credentials to KMS">
      ...
      Once added, restart your KMS instance and use the Azure App Configuration connection.
    </Step>
    </Steps>    
      ...
      <Tab title="OAuth">
        <Step title="Authorize Connection">
	      ...
	      <Step title="Grant Access">
	        ...
	        you will redirect you back to KMS's App Connections page. ![Azure App Configuration
