...
description: "Learn how to configure a Windmill Connection for KMS."
---

KMS supports connecting to Windmill using Access Tokens.
...
## Setup Windmill Connection in KMS
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/app-connections/windmill \
