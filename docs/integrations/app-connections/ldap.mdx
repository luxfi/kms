...
description: "Learn how to configure an LDAP Connection for KMS."
---

KMS supports the use of [Simple Binding](https://ldap.com/the-ldap-bind-operation) to connect with your LDAP provider.
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
            --url https://kms.lux.network/api/v1/app-connections/ldap \
