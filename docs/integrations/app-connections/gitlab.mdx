...
description: "Learn how to configure a GitLab Connection for KMS using OAuth or Access Token methods."
---

KMS supports two methods for connecting to GitLab: **OAuth** and **Access Token**. Choose the method that best fits your setup and security requirements.
...
<Tabs>
  <Tab title="OAuth Method">
    ...
    <Accordion title="Self-Hosted Instance Setup">
      Using the GitLab Connection with OAuth on a self-hosted instance of KMS requires configuring an OAuth application in GitLab and registering your instance with it.

      **Prerequisites:**
      - A GitLab account with existing projects
      - Self-hosted KMS instance
      ...
      <Steps>
        ...
        <Step title="Add your GitLab OAuth application credentials to KMS">
          ...
          Back in your KMS instance, add two new environment variables for the credentials of your GitLab OAuth application:
          ...
          Once added, restart your KMS instance and use the GitLab Connection.
        </Step>
      </Steps>
    </Accordion>

    ## Setup GitLab OAuth Connection in KMS
    ...
    <Steps>
      ...
      <Step title="Grant Access">
        You will be redirected to GitLab to grant KMS access to your GitLab account. Once granted, you will be redirected back to KMS's App Connections page.
  ...
  <Tab title="Access Token Method">
    ...
    ## Setup GitLab Access Token Connection in KMS
