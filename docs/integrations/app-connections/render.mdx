...
description: "Learn how to configure a Render Connection for KMS."
---

KMS supports connecting to Render using API keys for secure access to your Render services.

## Configure API Key for KMS
...
## Setup Render Connection in KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **Render Connection** is now available for use in your KMS
