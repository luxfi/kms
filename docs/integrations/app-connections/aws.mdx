...
description: "Learn how to configure an AWS Connection for KMS."
---

KMS supports two methods for connecting to AWS.
        ...
        <Steps>
            <Step title="Create the Managing User IAM Role for KMS">
                ...
                <Warning type="warning" title="Security Best Practice: Use External ID to Prevent Confused Deputy Attacks">
                    When configuring an IAM Role that KMS will assume, it’s highly recommended to enable the **"Require external ID"** option and specify your **Organization ID**.
                    ...
                    <Tab title="Secret Sync">
                        <AccordionGroup>
                            <Accordion title="AWS Secrets Manager">
                                Use the following custom policy to grant the minimum permissions required by KMS to sync secrets to AWS Secrets Manager:
                            ...
                            <Accordion title="AWS Parameter Store">
                                Use the following custom policy to grant the minimum permissions required by KMS to sync secrets to AWS Parameter Store:
                    ...
                    <Tab title="Secret Rotation">
                        <AccordionGroup>
                            <Accordion title="AWS IAM">
                                Use the following custom policy to grant the minimum permissions required by KMS to rotate secrets to AWS Access Keys:
            ...
            <Step title="Setup AWS Connection in KMS">
                <Tabs>
                    <Tab title="KMS UI">
                    ...
                    <Tab title="API">
                        ...
                        ```bash Request
                        curl    --request POST \
                                --url https://kms.lux.network/api/v1/app-connections/aws \
