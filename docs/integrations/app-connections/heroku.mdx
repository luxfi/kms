...
description: "Learn how to configure a Heroku Connection for KMS using OAuth or Auth Token methods."
---

KMS supports two methods for connecting to Heroku: **OAuth** and **Auth Token**. Choose the method that best fits your setup and security requirements.
...
<Tabs>
  <Tab title="OAuth Method">
    ...
    <Accordion title="Self-Hosted Instance Setup">
      Using the Heroku Connection with OAuth on a self-hosted instance of KMS requires configuring an API client in Heroku and registering your instance with it.
      ...
      **Prerequisites:**
      ...
      <Steps>
        <Step title="Create an API client in Heroku">
          ...
          <Tip>
            The domain you defined in the OAuth callback URL should be equivalent to the `SITE_URL` configured in your KMS instance.
          </Tip>
        ...
        <Step title="Add your Heroku API client credentials to KMS">
          ...
          Once added, restart your KMS instance and use the Heroku Connection.
        </Step>
      </Steps>
    </Accordion>

    ## Setup Heroku OAuth Connection in KMS
    ...
    <Steps>
      ...
      <Step title="Grant Access">
        You will be redirected to Heroku to grant KMS access to your Heroku account. Once granted, you will be redirected back to KMS's App Connections page.
  ...
  <Tab title="Auth Token Method">
    ...
    ## Setup Heroku Auth Token Connection in KMS
