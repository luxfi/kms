...
description: "Learn how to configure a GCP Connection for KMS."
---

KMS supports [service account impersonation](https://cloud.google.com/iam/docs/service-account-impersonation) to connect with your GCP projects.
...
## Configure Service Account for KMS
...
<Steps>
    ...
    <Step title="Create Service Account">
        ...
        Your service account ID must end with the first two sections of your KMS organization ID.
        
        Example:
        - KMS organization ID: `df92581a-0fe9-42b5-b526-0a1e88ec8085`
