---
title: "Camunda Sync"
description: "Learn how to configure a Camunda Sync for KMS."
---
...
<Tabs>
    <Tab title="KMS UI">
        ...
        ![Configure Options](/images/secret-syncs/camunda/camunda-options.png)
            ...
            - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
                ...
                - **Import Secrets (Prioritize KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from KMS over Camunda when keys conflict.
                - **Import Secrets (Prioritize Camunda)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Camunda over KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://kms.lux.network/api/v1/secret-syncs/camunda \
