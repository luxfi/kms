---
title: "Zabbix Sync"
description: "Learn how to configure a Zabbix Sync for KMS."
---
...
<Tabs>
        ...
        <Steps>
            ...
            <Step title="Configure Sync Options">
                ...
                - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
                    ...
                    - **Import Secrets (Prioritize KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from KMS over Zabbix when keys conflict.
                    - **Import Secrets (Prioritize Zabbix)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Zabbix over KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/secret-syncs/zabbix \
