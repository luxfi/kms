...
description: "Learn how to configure a Hashicorp Vault Sync for KMS."
---
...
<Tabs>
        ...
        <Steps>
            ...
            <Step title="Configure Sync Options">
                ...
                - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
                    ...
                    - **Import Secrets (Prioritize KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from KMS over Hashicorp Vault when keys conflict.
                    - **Import Secrets (Prioritize Hashicorp Vault)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Hashicorp Vault over KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.lux.network/api/v1/secret-syncs/hashicorp-vault \
