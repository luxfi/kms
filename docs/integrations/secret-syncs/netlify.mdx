---
title: "Netlify Sync"
description: "Learn how to configure a Netlify Sync for KMS."
---
...
<Tabs>
    ...
    <Steps>
      ...
      <Step title="Configure Sync Options">
        ...
        - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
            ...
            - **Import Secrets (Prioritize KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from KMS over Netlify when keys conflict.
            - **Import Secrets (Prioritize Netlify)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Netlify over KMS when keys conflict.
        <Note>
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.lux.network/api/v1/secret-syncs/netlify \
