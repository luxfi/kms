...
description: "Learn how to configure an Azure App Configuration Sync for KMS."
---
...
<Note>
  ...
  for KMS to sync secrets to Azure App Configuration: `Read Key-Value`, `Write Key-Value`, `Delete Key-Value`.
...
<Tabs>
    <Tab title="KMS UI">
        ...
        ![Configure Destination](/images/secret-syncs/azure-app-configuration/app-config-destination.png)
            ...
            - **Label**: An optional label to attach to all secrets created by KMS inside your Azure App Configuration.
        ...
        ![Configure Options](/images/secret-syncs/azure-app-configuration/app-config-options.png)
            ...
            - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
                ...
                - **Import Secrets (Prioritize Azure App Configuration)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Secrets Manager over KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://kms.lux.network/api/v1/secret-syncs/azure-app-configuration \
