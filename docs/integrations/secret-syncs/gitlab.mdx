---
title: "GitLab Sync"
description: "Learn how to configure a GitLab Sync for KMS."
---
...
<Tabs>
    <Tab title="KMS UI">
        ...
        ![Configure Destination](/images/secret-syncs/gitlab/gitlab-secret-sync-destination.png)
            ...
            <Warning>
                If you enable **Mark secrets as Hidden**, KMS will not be able to unhide/unmask secrets from the sync destination if you disable the option later. This is because GitLab does not allow to unhide/unmask existing secrets.
            </Warning>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://kms.lux.network/api/v1/secret-syncs/gitlab \
