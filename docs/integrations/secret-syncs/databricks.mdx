...
description: "Learn how to configure a Databricks Sync for KMS."
---
...
<Tabs>
    <Tab title="KMS UI">
        ...
        ![Configure Destination](/images/secret-syncs/databricks/databricks-destination.png)
            ...
            <Note>
                ...
                KMS recommends creating a designated Databricks secret scope for your sync to prevent removal of secrets not managed by KMS.
            </Note>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://kms.lux.network/api/v1/secret-syncs/databricks \
