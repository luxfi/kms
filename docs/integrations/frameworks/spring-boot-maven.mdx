...
description: "How to use KMS to inject environment variables into Java Spring Boot"
---

Prerequisites:

- Set up and add your environment variables to [KMS Cloud](https://kms.lux.network)
- [Install the CLI](/cli/overview)

## Initialize KMS 
In order for KMS to know which secrets to fetch, you'll need to first initialize KMS at the root of your project. 
...
To pass in KMS secrets into your application, we will utilize the KMS CLI to inject the secrets into the Maven wrapper executable, which is used to launch your application. 
...
**Step 5:** When you need to run a block of code in debug mode, select the KMS script
