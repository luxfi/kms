...
description: "Learn about call rotation at KMS"
---

KMS is mission-critical software, which means minimizing service disruptions is a top priority. 
...
- **Set Up PagerDuty:** Ensure you have the PagerDuty mobile app installed, configured, and notifications enabled for KMS services.
- **Access Required Tools:** Verify access to internal network, runbooks on Notion, [https://grafana.lux.network](https://grafana.lux.network/), access to aws accounts and any other access you may require.
...
- [AWS Portal](https://kms.awsapps.com/start/)
- [View metrics on Grafana](https://grafana.lux.network/)
- [Metabase](https://analytics.internal.lux.network/)
