  ...
  return (
    <div className="rounded-lg border border-mineshaft-600 bg-mineshaft-900 p-6">
                ...
                <div>
                  ...
                  <p className="mt-4">
                    ...
                    <a
                      ...
                      href="/docs/documentation/platform/sso/overview#sso-break-glass"
                      rel="noreferrer"
                    >
                      Admin Login Portal
                    </a>{" "}
      ...
      <UpgradePlanModal
        ...
        text="Your current plan does not include access to enforce SAML SSO. To unlock this feature, please upgrade to KMS Pro plan."
      />
      <Modal
