  ...
  const handleSetRoleAsDefault = async (defaultMembershipRoleSlug: string) => {
    ...
    if (isCustomRole && subscription && !subscription?.rbac) {
      handlePopUpOpen("upgradePlan", {
        text: "Your current plan does not include access to set a custom default organization role. To unlock this feature, please upgrade to KMS Pro plan."
      });
      return;
    }
    ...
    <div className="rounded-lg border border-mineshaft-600 bg-mineshaft-900 p-4">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-x-2">
          ...
          <DocumentationLinkBadge href="/docs/documentation/platform/organization#roles-and-access-control" />
        </div>
