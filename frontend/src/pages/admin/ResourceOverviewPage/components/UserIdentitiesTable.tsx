                                  ...
                                  onClick={(e) => {
                                    ...
                                    if (!subscription?.instanceUserManagement) {
                                      handlePopUpOpen("upgradePlan", {
                                        username,
                                        id,
                                        text: "Your current plan does not allow setting additional server admins. To unlock this feature, please upgrade to KMS Pro plan."
                                      });
                                      return;
                                    }
                                  ...
                                  onClick={(e) => {
                                    ...
                                    if (!subscription?.instanceUserManagement) {
                                      handlePopUpOpen("upgradePlan", {
                                        username,
                                        id,
                                        text: "Your current plan does not allow removing server admins. To unlock this feature, please upgrade to KMS Pro plan."
                                      });
                                      return;
                                    }
