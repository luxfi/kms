            ...
            render={({ field: { onChange, value } }) => (
              <div className="max-h-32 opacity-100 transition-all duration-300">
                <SecretProtectionOption
                  ...
                  tooltip="Secrets can only be marked as hidden if they are also masked. If this is enabled, KMS will not be able to unhide/unmask secrets from the sync destination if you disable the option later."
                  isEnabled={value || false}
                  onChange={onChange}
